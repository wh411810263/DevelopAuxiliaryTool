using DevelopAuxiliaryTool.AddDatabase.MySql.Model;
using DevelopAuxiliaryTool.Utility;
using System;
using System.Collections.Generic;
using System.Text;

namespace DevelopAuxiliaryTool.AddDatabase.MySql.BLL
{
    //构建实体模型的类
    public class MySqlEntityBuild : IEntityBuild
    {
        ...
        /// <returns></returns>
        public ICreateEntityFile EntityBuild(EntityBuildModel model)
        {
